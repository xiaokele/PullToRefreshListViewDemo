 ...
 * 根据类型添加header和footer
 */
public class MoreTypeListView2Activity extends AppCompatActivity {
    ...
    public class NormalHolde extends BaseHoldle {
        ...
        public View ininViewHoldle() {
            View view = View.inflate(MoreTypeListView2Activity.this.getApplicationContext(), R.layout.item_listview, null);
    ...
    public class LoadmoreHoldle extends BaseHoldle {
        ...
        @Override
        public View ininViewHoldle() {
            view = View.inflate(MoreTypeListView2Activity.this.getApplicationContext(), R.layout.refresh_footer, null);
