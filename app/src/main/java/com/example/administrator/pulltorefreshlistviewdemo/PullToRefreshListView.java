...
public class PullToRefreshListView extends ListView {
    ...
    private void initHeaderView() {
        ...
        iv_arrow = (ImageView) headerView.findViewById(R.id.iv_refresh_down);
        progress_bar = (ProgressBar) headerView.findViewById(R.id.pull_to_refresh_progress);
        showRefreshingProgressBar(false);
        tv_state = (TextView) headerView.findViewById(R.id.pull_to_refresh_text);
